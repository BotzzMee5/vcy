...
⬡ Upload: ${publishedTime}
⬡ Link: ${vid.url}
╰────────⬣`, wm.trim(), await( await conn.getFile(thumbnail)).data, [['Video', `.ytv ${vid.url}`]], false, { quoted: m, 'document': { 'url':'https://wa.me/+6283174508962' },
...
sourceUrl: 'http://wa.me/+6283174508962', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
